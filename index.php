    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      ...
      <div class="hidden w-full md:block md:w-auto" id="navbar-default">
        <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0 bg-gray-900 border-gray-700">
          <li>
            <a href="http://localhost" class="block py-2 pl-3 pr-4 rounded md:border-0 md:p-0 text-blue-400 hover:text-blue-900 flex flex items-center justify-center" aria-current="page">
